<!-- Otetaan mikä pizza ollaan tilaamassa -->
...
<body>
    <nav class="navbar navbar-default navbar-expand-lg navbar-light scrolling-navbar fixed-top">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right ml-auto">
                <?php  if (isset($_SESSION['email'])) : ?>
                <li class="nav-item active"><a class="nav-item nav-link" href="tilaus">Ostoskori</a></li>
    ...
    <div class="">
        <div class="login-form-1">
            <form action="" method="post" onsubmit="processOrder()">
                <input type="hidden" name="pizzatHidden" id="pizzat" value="">
                <input type="hidden" name="hintaHidden" id="hinta5" value="">
                <div class="container text-center">
                    ...
                    <div class="row">
                        <h3 id="hinta">Loppuhinta: €</h3>
                    </div>
                    <div class="row" style="padding-top:5px">
                        <button type="submit" class="btn btn-block btn-md btn-success" name="new_order">Tilaa!</button>
                    </div>
                </div>
            </form>
        </div>
